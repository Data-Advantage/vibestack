...
- [1.3.6: Configure Custom Domain](#136-configure-custom-domain)
...
Deploy your landing page to Vercel directly from v0 to make it publicly accessible:

1. **Deploy with v0**:
   - In your v0 project, look for the "Deploy" button in the top navigation bar
   - Click "Deploy" to open the deployment dialog
   - Choose Vercel as your deployment platform (should be pre-selected)
   - v0 will automatically connect to Vercel and prepare your project for deployment

2. **Configure deployment settings**:
   - Verify that the project name is appropriate (or customize it)
   - Framework preset should automatically be set to Next.js
   - Ensure that all build settings are correct:
     - Root directory: ./
     - Build command: (leave as default)
     - Output directory: (leave as default)

3. **Add environment variables**:
   - In the deployment dialog, add your Supabase environment variables:
     ```
     NEXT_PUBLIC_SUPABASE_URL=your_supabase_project_url
     NEXT_PUBLIC_SUPABASE_ANON_KEY=your_supabase_anon_key
     ```
   - These environment variables are essential for the Supabase authentication system which powers your waitlist signup functionality
...
5. **Update Supabase settings**:
   ...
   - Add redirect URLs for authentication flow if necessary:
     ...
     https://your-project-name.vercel.app/auth/reset-password
     ```
   - This configuration ensures your waitlist signup form works correctly on the deployed site

### 1.3.6 Configure Custom Domain

After deploying your site, configure a custom Vercel subdomain for a more professional appearance:
...
4. **Update environment variables if necessary**:
   - If you've hardcoded your site URL anywhere in your application code
   - Update the "NEXT_PUBLIC_SITE_URL" environment variable in your Vercel project settings
