...
## Table of Contents
- [1.5.1: Review Existing Progress](#151-review-existing-progress)
- [1.5.2: Add Convex Outputs to Project](#152-add-convex-outputs-to-project)
- [1.5.3: Task-Based Implementation Strategy](#153-task-based-implementation-strategy)
- [1.5.4: Generate Implementation Plan](#154-generate-implementation-plan)
- [1.5.5: Generate Implementation Prompts](#155-generate-implementation-prompts)
- [1.5.6: Implementing Your First Tasks](#156-implementing-your-first-tasks)
- [1.5.7: Iterative Development Process](#157-iterative-development-process)
- [1.5.8: Connecting Components and Services](#158-connecting-components-and-services)
- [1.5.9: Testing Your Prototype](#159-testing-your-prototype)
- [1.5.10: Deployment and Next Steps](#1510-deployment-and-next-steps)
...
- `convex/queries/*`
- `convex/mutations/*`
Then set these in v0 Project Settings:
...
Now that you've completed your working prototype, proceed to [Day 2](../2-refine/README.md) where you'll gather feedback and refine your application based on user insights. 