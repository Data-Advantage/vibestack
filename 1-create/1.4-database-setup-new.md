...
1. EXTENSIONS
   ...
   - Check supbase-database-patterns to see the list of extensions enabled by default and a list of optional extensions (only turn on if really needed)
   - Future roadmap functionality expansions can enable additional extensions at that time
