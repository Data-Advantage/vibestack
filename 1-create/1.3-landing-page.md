...
2. **Customize the Landing Page with v0.dev**:
   ...
   4. Create a responsive page on `/` with:
      ...
      - Call-to-action for waitlist signup using Supabase's built-in auth system (NOT a custom table)
      - Success confirmation after signup

   Implement with:
   - Supabase Starter's built-in signup form - DO NOT create a custom waitlist table
