...
- [1.3.3: Add Technical References to Knowledge](#133-add-technical-references-to-knowledge)
...
### 1.3.3: Add Technical References to Knowledge

Add these documents to Project Settings → Knowledge → Sources so v0 agents can reference deeper technical details:

- [clerk-billing.md](../0-learn/clerk-billing.md)
- [convex-diagnostics.md](../0-learn/convex-diagnostics.md)
- [convex-setup-workflow.md](../0-learn/convex-setup-workflow.md)
- [dark-mode.md](../0-learn/dark-mode.md)
- [development-plan.md](../0-learn/development-plan.md)
